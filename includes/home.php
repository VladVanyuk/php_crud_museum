        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <?php
            ...
            while($row= mysqli_fetch_assoc($view_users)){
              ...
              echo " <td  class='text-center'>  <a href='find.php?delete={$id}' class='btn btn-success'><i class='bi bi-zoom-in'></i> FIND</a> </td>";

              echo " <td  class='text-center'>  <a href='search.php?delete={$id}' class='btn btn-light'><i class='bi bi-zoom-in'></i> SEARCH</a> </td>";
              echo " </tr> ";
                  }  
                ?>
              </tr>  
